...
from zhihu_user.items import UserInfoItem, UserActionItem
from zhihu_user.items import AnswerItem, QuestionItem
import datetime
from zhihu_user.settings import cookie, DATETIME_FORMAT, DATE_FORMAT
        ...
        if not is_end:
            ...
            for action in action_json['data']:
                ...
                if useraction_item['verb'] == "ANSWER_VOTE_UP" or useraction_item['verb'] == "ANSWER_CREATE":
                    ...
                    yield scrapy.Request(self.questions_url.format(question_id=useraction_item['target_question_id']),
